...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className="py-[20px] px-0 flex justify-between items-center">
      ...
      <div className="flex items-center gap-10 max-1050:gap-[30px] max-900:gap-5 ">
        ...
        <button onClick={()=>setShowLogin(true)} className="bg-transparent text-[16px] text-[#49557e] border-[1px] border-solid border-[tomato] py-2.5 px-7 rounded-full cursor-pointer hover:bg-[#fff4f2] transition max-1050:py-2 max-1050:px-[25px] max-900:py-[7px] max-900:px-5 max-900:text-[15px] ">
          Sign in
        </button>
      </div>
    </div>
